...
namespace {
    static CnsFillExtDir enlightning_fill_ext_dir;
    static GpuBndryFuncFab<CnsFillExtDir> gpu_bndry_func(enlightning_fill_ext_dir);
...
// scomp               : component index for dcomp as in the desciptor set up in enlightning::variableSetUp.

void enlightning_bcfill (Box const& bx, FArrayBox& data,
                 const int dcomp, const int numcomp,
