...
int enlightning::num_state_data_types = NUM_STATE_DATA_TYPE;
...
enlightning::variableSetUp ()
{
    ...
    StateDescriptor::BndryFunc bndryfunc(enlightning_bcfill);
